...
This is NOT the Nexus release build. It:
  ...
  - Writes all persistent data to H:\\Mossy Memory at runtime
...
echo.
echo Status file: H:\\Mossy Memory\\bridge_status.json
echo.
pause
"""
...
echo [F4AI] Memory      : H:\\Mossy Memory
echo.
...
MEMORY STORAGE (all automatic, no setup needed)
  H:\\Mossy Memory\\NPC_Memories\\     per-NPC dialogue history
  H:\\Mossy Memory\\Training_Cache\\   DPO training records
  H:\\Mossy Memory\\Adapters\\         LoRA adapters
  H:\\Mossy Memory\\modlist_db.json    modlist intelligence database
