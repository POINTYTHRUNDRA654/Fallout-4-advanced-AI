Scriptname F4AI_StatusHolotapeScript extends Quest
{ Pip-Boy holotape: reads H:\Mossy Memory\bridge_status.json and displays
...
String Property StatusFilePath = "H:/Mossy Memory/bridge_status.json" Auto Const
...
Function ShowBridgeStatus()
    ...
    String source    = _ExtractField(statusJson, "source")
    String npcName   = _ExtractField(statusJson, "npc")
    String location  = _ExtractField(statusJson, "location")
...
Function ShowMemoryStatus()
    ...
    Debug.MessageBox( \
        "F4AI MEMORY STORAGE\n" + \
        "===================\n\n" + \
        "Location: H:\\Mossy Memory\\\n\n" + \
        memDisplay)
EndFunction

; ── Private JSON field extractor ─────────────────────────────────────────────

String Function _ExtractField(String jsonText, String key)
